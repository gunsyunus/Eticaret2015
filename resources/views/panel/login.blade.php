...
<g>
                    ...
                    <div class="card tab2-card">
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="top-tabContent">
                                ...
                                {!! Form::open(['url'=>'Pv3/login','role'=>'form','class'=>'form-horizontal auth-form']) !!}
    ...
    {{ HTML::script('panelv3/js/slick.js') }}
    {{ HTML::script('panelv3/js/jsgrid/jsgrid.min.js') }}
    {{ HTML::script('panelv3/js/jsgrid/griddata-invoice.js') }}
    {{ HTML::script('panelv3/js/jsgrid/jsgrid-invoice.js') }}
