...
@section('title', ''.$brand->bname.' '.$brand->title.'')
@section('keyword', ''.$brand->bname.','.$brand->keyword.'')
@section('description', ''.$brand->bname.' - '.$brand->description.'')
    ...
    <div class="row">
      <div class="inner">
        <ul>
          ...
          <li class="category13"><strong>{{ $brand->bname }}</strong></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-main col-sm-9 col-sm-push-3">
        <article class="col-main">
          <div class="page-title" style="padding-left:20px;"><h1> {{ $brand->bname }} </h1></div>
            ...
            <div id="sort-by">
              ...
              <ul> 
                <li style="border-bottom:1px solid #BDBDBD;"><a href="#">{{ $sortSelect->name }} <span class="right-arrow"></span></a>
                  <ul>
                    <li><a href="{{ url()->current().'?sort=price_asc' }}">Artan Fiyat</a></li>
                    <li><a href="{{ url()->current().'?sort=price_desc' }}">Azalan Fiyat</a></li>
                    <li><a href="{{ url()->current().'?sort=name_asc' }}">A-Z Arası</a></li>
                    <li><a href="{{ url()->current().'?sort=name_desc' }}">Z-A Arası</a></li>
                  </ul>
                </li>
              </ul>
            </div>
