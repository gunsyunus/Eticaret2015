...
@section('title', ''.$designs->product_title_text.' - '.$settings->title.'')
@section('keyword', ''.$designs->product_title_text.','.$settings->keyword.'')
@section('description', ''.$designs->product_title_text.' - '.$settings->description.'')
    ...
    <div class="row">
      <div class="inner">
        <ul>
          ...
          <li class="category13"><strong>{{ $designs->product_title_text }}</strong></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-main col-sm-9 col-sm-push-3">
        <article class="col-main">
          <div class="page-title" style="padding-left:20px;"><h1>{{ $designs->product_title_text }}</h1></div>
